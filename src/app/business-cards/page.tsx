...
export const metadata = {
  ...
  description:
    "Premium business cards in standard, premium, and specialty finishes. Matte, UV gloss, metallic foil, kraft paper, plastic, magnetic, and more.",
};
...
const BUSINESS_CARD_GROUPS = [
  ...
  },
  {
    ...
    slug: "premium",
    description:
      "Metallic foil, kraft paper, spot UV, pearl, die cut, soft touch, painted edge & more.",
    image:
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="mt-2 text-muted">
            ...
            cards. From classic matte and gloss to premium finishes and specialty
            materials.
          </p>
        </div>
